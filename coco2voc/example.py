...
if __name__ == '__main__':
    ...
    annotations_file = '/mnt/d/RarePlanes/aircraft_real_coco.json'
    data_folder = '/mnt/d/RarePlanes/datasets/real/train/PS-RGB_tiled/'
    labels_target_folder = '/mnt/d/RarePlanes/datasets/real_voc_format'



    # Convert n=25 annotations
    coco2voc(annotations_file, labels_target_folder, n=None, compress=True)
    ...
    for id in id_list:
        ...
        instance_filename = os.path.join(labels_target_folder, 'instance_labels', file_name)
        class_filename = os.path.join(labels_target_folder, 'class_labels', file_name)
